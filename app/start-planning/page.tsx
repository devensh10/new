  ...
  return (
    <div className="min-h-screen bg-travozom-beige dark:bg-travozom-deep-brown text-travozom-deep-brown dark:text-travozom-cream transition-colors duration-300">
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden mt-16">
        <Image src="/placeholder.svg?height=600&width=1200" alt="Start Planning Hero" fill className="object-cover" />
        <div className="absolute inset-0 bg-travozom-deep-brown/70 dark:bg-black/80" />
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-serif text-white mb-4">Start Your Luxury Journey</h1>
          <p className="text-xl text-travozom-light-beige">
            Tell us your travel dreams, and we'll craft an unforgettable Indian adventure.
          </p>
        </div>
      </section>
            ...
            <CardContent>
              <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input id="duration" type="number" placeholder="7" min="1" />
                </div>
                <div>
            ...
            <Card className="bg-white dark:bg-travozom-deep-brown/50 border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-travozom-dark-beige dark:text-travozom-light-beige">
                  Our AI will generate a preliminary itinerary based on your inputs within 24 hours.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white dark:bg-travozom-deep-brown/50 border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-travozom-dark-beige dark:text-travozom-light-beige">
                  A dedicated travel expert will contact you to refine the itinerary and answer all your questions.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white dark:bg-travozom-deep-brown/50 border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-travozom-dark-beige dark:text-travozom-light-beige">
                  Once finalized, we handle all bookings – flights, hotels, guides, and activities – for a stress-free
                  experience.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-gradient-to-r from-travozom-deep-brown to-travozom-dark-beige text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-travozom-light-beige mb-8">
            Let Traozom be your trusted partner in crafting extraordinary memories.
          </p>
          <Button
            size="lg"
